...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-[#1a1a1a] border-t border-[rgba(249,115,22,0.1)] overflow-hidden">
      {/* Background Grid */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div className="col-span-2 md:col-span-1 space-y-3 sm:space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg sm:text-xl font-bold text-white">Flossy</span>
            </div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              {footerLinks.product.map((link) => (
                <li key={link.name}>
                  <a 
                    href={link.href}
                    className="text-gray-400 hover:text-[#f97316] transition-colors duration-200 text-xs sm:text-sm"
                  >
                    {link.name}
                  </a>
                </li>
        ...
        {/* Bottom Bar */}
        <div className="pt-6 sm:pt-8 border-t border-[rgba(249,115,22,0.1)]">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-500 text-xs sm:text-sm text-center md:text-left">
              © 2024 Flossy. Built for real people with real dental questions.
            </p>

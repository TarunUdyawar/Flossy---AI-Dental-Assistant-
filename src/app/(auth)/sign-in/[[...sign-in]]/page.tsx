...
const SignInPage = () => {
  return (
    <div className="min-h-screen w-full relative overflow-hidden bg-[#0a0c14]">
      ...
      {/* Glowing orbs */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#f97316] rounded-full blur-[120px] opacity-15 animate-pulse" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-[#18cef2] rounded-full blur-[120px] opacity-10 animate-pulse" style={{ animationDelay: '1s' }} />
